...
.text
.align 2
puttime:	ldw r8, 0(r4)			#Spara värdet för tiden som ska skrivas ut
			...
			#call lcdput				#Skriv ut ny line på lcd
...
loop:		srl r9, r8, r11			#Shifta talbitarna rätt
			...
			#call lcdput				#Skriv ut ascii-koden på lcd
			POPALL					#Ladda alla sparade register
...
kolon:		movi r4, 0x3A			#Ladda in ascii-koden för kolon
			PUSHALL					#Spara alla register vi använder innan vi kallar på subrutin
			call putchar			#Skriv ut kolon
			#call lcdput				#Skriv ut kolon på lcd
			POPALL					#Ladda alla sparade register
