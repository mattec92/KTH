...
public class BinaryTreeSet<E> implements Set<E>  { //implements Set<E>
	...
	public BinaryTreeSet(Set<E> set) {
		root = null;
		for(E element : set) {
			add(element);
		}
...
//}
	...
	public BinaryTreeSet<E> union (Set<E> set) {
		BinaryTreeSet<E> setout = new BinaryTreeSet<E>(this);
	...
	public BinaryTreeSet<E> intersection(Set<E> set) {
		BinaryTreeSet<E> setout = new BinaryTreeSet<E>();
	...
	public BinaryTreeSet<E> difference (Set<E> set) {
		BinaryTreeSet<E> setout = new BinaryTreeSet<E>();
		//Går genom hela mängden och kollar om elementet finns i den andra mängden.
	...
	private class JIterator implements Iterator<E> {
		...
		public JIterator() {
			elements = BinaryTreeSet.this.toArray();
		...
		public void remove() {
			...
			BinaryTreeSet.this.remove(elements[lastReturnedIndex]);
			lastReturnedIndex = -1;
		}
	}
	...
	public static void main(String[] arg) {
		BinaryTreeSet<Integer> s = new BinaryTreeSet<Integer>();
		s.add(5);
		s.add(2);
		s.add(6);
		s.add(3);
		...
		BinaryTreeSet<Integer> d = new BinaryTreeSet<Integer>(s);
		d.add(7);
